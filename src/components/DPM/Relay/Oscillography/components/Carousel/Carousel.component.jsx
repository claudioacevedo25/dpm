...
const CarouselComponent = (props) => {
  return (
    <div
      className={
        props.hideDetails ? "carousel_container_extended" : "carousel_container"
      }
    >
      ...
      <Carousel
        className={`carousel_container ${
          props.hideDetails
            ? "carousel_container_extended-interior"
            : "carousel_container-interior"
        }`}
        showThumbs={false}
        showIndicators={false}
        showStatus={false}
        onChange={(index, item) => {
          props.setIndexToShow(index);
        }}
      >
        {props.graphsData ? (
                ...
                if (indexOfGraph === props.indexToShow) {
                  return (
                    <div
                      ...
                      key={"phasorG" + indexOfGraph}
                    >
                      <Phasor
                        width={props.hideDetails ? 320 : 240}
                        vectorData={props.currentGraphDataFiltered.vars}
                      />
                    </div>
                  );
                } else {
                  ...
                  return (
                    <div className="carousel_body" key={"lineG" + indexOfGraph}>
                      <Chart
                        ...
                        xaxis_name={
                          props.currentGraphDataFiltered["xaxis_name"]
                        }
                        yaxis_name={
                          props.currentGraphDataFiltered["yaxis_name"]
                        }
