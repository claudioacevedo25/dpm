...
const CurrentSelectorComponent = (props) => {
  ...
  return (
    props.currentGraphData && (
      <div className="current_selector_container">
        <Select
          value={1}
          className="carousel_header_select"
          onChange={props.handleCurrentSelect}
        >
          <MenuItem value={1}>
            <em>Señales</em>
          </MenuItem>
        ...
        <div
          className={
            props.hideDetails
              ? "chip_scrollable_container_extended"
              : "chip_scrollable_container"
          }
        >
